namespace :ph do
  desc "producthunt"
  task import_posts_by_product: :environment do
    # Your task logic here
    puts "aa"
    1000.times { import_posts_by_product "/root/run/tmp/posts-by-product" }
  end
end
...
def helper_save_user_to_json u
  File.write("tmp-users-json/#{u["id"]}.json", u.to_json.to_s)
end
