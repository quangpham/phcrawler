...
curl 'https://www.producthunt.com/frontend/graphql' \
        ...
        "query":"query TopicPage($slug:String\u0021$cursor:String$order:ProductsOrder\u0021)
          {
            topic(slug:$slug)
              {
                id slug name description postsCount followersCount parent{id name slug __typename}
                ...
                recentStacks(first:10)
                  {
                    edges
                      {
                        node{id ...TopicPageRecentStackFragment __typename}
                        __typename
                      }
                      totalCount pageInfo {endCursor hasNextPage}
                    __typename
          ...
          fragment TopicPageRecentStackFragment on ProductStack{id user{id ...UserInfo __typename} product{id name tagline slug ...ProductExtra __typename}__typename}
  ...
  --compressed> "tmp/_r.topic-detail.$1.$2.$3.$4.ongoing"
  mv "tmp/_r.topic-detail.$1.$2.$3.$4.ongoing" "tmp/_r.topic-detail.$1.$2.$3.$4.json"
