...
user_ids += User.where("(username like '%nguyen%' or username like '%tran%' or username like '%pham%') and following > 10 and last_active_at > '2023-01-01 00:00:21'").select(:id).collect {|u| u.id}
