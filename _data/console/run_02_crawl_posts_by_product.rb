...
ssh root@188.166.241.233 "cd /root/run/ && mkdir -p done_02_a/a done_02_a/b tmp/reviewers-by-product/ && find tmp/posts-by-product/ -name '*.json' -exec mv -t done_02_a/a/ {} + && find tmp/reviewers-by-product/ -name '*.json' -exec mv -t done_02_a/b/ {} + && zip -r done_02_a.zip done_02_a/"
scp root@188.166.241.233:/root/run/done_02_a.zip /Users/quang/Downloads/ok/posts-by-product/
